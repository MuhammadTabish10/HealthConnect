...
public class RouteConstants {
    ...
    public static final String APPOINTMENT_SERVICE_ID = "APPOINTMENT-SERVICE";
    ...
    public static final String APPOINTMENT_SERVICE_PATH = "/api/v1/appointments/**";
    ...
    public static final String APPOINTMENT_SERVICE_URI = "lb://APPOINTMENT-SERVICE";
