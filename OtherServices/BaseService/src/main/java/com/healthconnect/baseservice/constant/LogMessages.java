...
public class LogMessages {
    ...
    public static final String ENTITY_FETCH_BY_NAME_SUCCESS = "Entity of type {} found with Name: {}";
    ...
    public static final String ENTITY_FETCH_BY_NAME_START = "Fetching entity of type {} with name: {}";
    ...
    public static final String ENTITY_FETCH_BY_NAME_ERROR = "Entity of type %s with name: %s not found";
